<div class="flex flex-wrap  w-full xl:mx-0 ">
    @foreach ($vendors as $vendor)
        <div class="w-full flex flex-col md:w-1/2 lg:w-1/3 xl:w-1/3 ">
            <a href="/vendors/{{ $vendor->id}}" class="rounded-lg bg-blue-500 flex flex-col flex-1  shadow hover:shadow-lg translateY-2px m-2 no-underline transition">
                @if ($showimage)
                ...
                <div class="p-2 bg-white flex flex-col flex-1 subpixel-antialiased">
                    ...
                    <div class="w-full flex flex-row border-t border-gray-200 text-sm font-thin">
                        ...
                        <div class="text-right w-1/2 mt-2">{{ $vendor->user->name }}</div>
                    </div>
                </div>
            </a>
        </div>
