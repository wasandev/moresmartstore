<div class="grid grid-cols-1  md:grid-cols-4 ">
    @foreach ($posts as $post)
        <div>
        <a href="/post/{{ $post->id }}" class="flex flex-col flex-1 shadow hover:shadow-lg translateY-2px m-2 no-underline transition">
                @if ($showimage)
                ...
                <div class="p-2 text-left subpixel-antialiased">
                    ...
                    <div class="w-full flex flex-row border-t border-gray-100 text-sm font-thin ">
                        <div class="text-left w-1/3 m-1 items-center">
                        ...
                        <div class="text-right w-2/3 mt-1 items-center">{{formatDateThai( $post->published_at )}}</div>
                    </div>
                </div>
            </a>
        </div>
