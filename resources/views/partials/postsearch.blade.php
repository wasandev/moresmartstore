    ...
    <form action="/post" method="POST" role="search">
        ...
        <div class="max-w-md mx-auto mx-0 ">
            <div class="flex w-full p-4 md:p-4">
                ...
                <input name="post-search" type="text" placeholder="ค้นหาโพส" class="transition-colors duration-100 ease-in-out focus:outline-0 border border-transparent focus:bg-white  placeholder-gray-600 rounded-lg bg-gray-100 py-2 pr-4 pl-10 block w-full appearance-none leading-normal ">
