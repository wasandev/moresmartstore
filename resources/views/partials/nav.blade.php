<div class="bg-white shadow-md lg:flex lg:justify-between lg:items-center lg:px-4 lg:py-2  fixed top-0 inset-x-0 z-50 ">
        ...
        <div id="main-nav" class="lg:block lg:w-auto hidden text-base font-medium lg:bg-white bg-gray-200 text-center">
            <div class="lg:flex lg:justify-between items-center">
                <a href="/" class="mx-4 block px-4 py-1 text-gray-800  rounded-full border  border-gray-200 hover:bg-blue-500 hover:text-gray-100">
                ...
                <a href="/vendors" class="mx-4 block px-4 py-1 text-gray-800  rounded-full border border-gray-200 hover:bg-blue-500 hover:text-gray-100  ">
                ...
                <a href="/products" class="mx-4 block px-4 py-1 text-gray-800  rounded-full border border-gray-200 hover:bg-blue-500 hover:text-gray-100 ">
                ...
                <a href="/post" class="mx-4 block px-4 py-1 text-gray-800  rounded-full border border-gray-200 hover:bg-blue-500 hover:text-gray-100 ">
                ...
                <a href="/blogs" class="mx-4 block px-4 py-1 text-gray-800  rounded-full border border-gray-200 hover:bg-blue-500 hover:text-gray-100  ">
            ...
            @auth
                <div class="px-4 py-1 lg:hidden bg-white mt-2">
