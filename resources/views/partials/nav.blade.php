<div class="bg-white shadow-md lg:flex lg:justify-between lg:items-center lg:px-4 lg:py-2  fixed top-0 inset-x-0 z-50 ">
        ...
        <div id="main-nav" class="lg:block lg:w-auto hidden text-base font-medium lg:bg-white bg-gray-200 text-center">
            <div class="lg:flex lg:justify-between items-center">
                <a href="/" class="mx-4 block px-4 py-2 text-gray-800  rounded-full bg-gray-200 hover:bg-blue-700 hover:text-gray-100">
                ...
                <a href="/vendors" class="mx-4 block px-4 py-2 text-gray-800  rounded-full bg-gray-200 hover:bg-blue-700 hover:text-gray-100  ">
                ...
                <a href="/products" class="mx-4 block px-4 py-2 text-gray-800  rounded-full bg-gray-200 hover:bg-blue-700 hover:text-gray-100 ">
                ...
                <a href="/post" class="mx-4 block px-4 py-2 text-gray-800  rounded-full bg-gray-200 hover:bg-blue-700 hover:text-gray-100 ">
                ...
                <a href="/blogs" class="mx-4 block px-4 py-2 text-gray-800  rounded-full bg-gray-200 hover:bg-blue-700 hover:text-gray-100  ">
                    ...
                    <div class="relative group hidden lg:block lg:ml-6">
                        ...
                        <div  class="flex items-center cursor-pointer  text-gray-800  group-hover: border-gray  hover:text-blue">
                            <img class="h-8 w-8 border-2 border-grey-light rounded-full object-cover" src="{{ Storage::url(Auth::user()->avatar) }}"
                                alt="">
                            <span class="ml-3 mt-1 px-4 py-2 rounded-full text-red-500 hover:bg-red-500 hover:text-gray-100 border-2 border-red-500">{{ Auth::user()->name }}</span>
                        </div>

                        <div class="w-48 absolute right-0 mt-0 py-2 bg-white rounded-lg shadow-xl invisible group-hover:visible">
                            <a href="/home"
                ...
                @else
                    <a href="{{ route('login') }}"
                        class=" mx-4 block px-4 py-2 text-red-600 border-2 border-red-500 rounded-full hover:bg-red-500 hover:text-gray-100">
            ...
            @auth
                <div class="px-4 py-2 lg:hidden bg-white">
                    ...
                    <div class="mt-4">
                        <a href="/home" class="px-2 py-1 mt-2 block text-gray-800  rounded-full hover:bg-blue-700 hover:text-gray-100 lg:mt-0 lg:ml-2">
                            <svg xmlns="http://www.w3.org/2000/svg" class="fill-current absolute mr-4"  width="20" height="20" viewBox="0 0 20 20"><path d="M18 9.87V20H2V9.87a4.25 4.25 0 0 0 3-.38V14h10V9.5a4.26 4.26 0 0 0 3 .37zM3 0h4l-.67 6.03A3.43 3.43 0 0 1 3 9C1.34 9 .42 7.73.95 6.15L3 0zm5 0h4l.7 6.3c.17 1.5-.91 2.7-2.42 2.7h-.56A2.38 2.38 0 0 1 7.3 6.3L8 0zm5 0h4l2.05 6.15C19.58 7.73 18.65 9 17 9a3.42 3.42 0 0 1-3.33-2.97L13 0z"/></svg>
                            <span class="ml-6">จัดการข้อมูลธุรกิจ</span>
                        </a>
