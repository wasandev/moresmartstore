<footer class="bg-gray-900 lg:flex lg:justify-between lg:items-center lg:px-4 lg:py-2 ">
    ...
    <div class="flex items-center justify-between px-4 py-3 lg:p-0">
        <div class="px-2 pt-2 pb-4 lg:flex lg:p-0 lg:items-left lg:w-auto text-gray-300 text-sm font-thin">
            <a href="https://moresmartstore.com" class="text-gray-300 text-sm  hover:text-yellow-500">Moresmartstore.com</a>
    ...
    <div id="footer-nav" class="lg:block lg:w-auto hidden">


        <div class="px-2 pt-2 pb-4 lg:flex lg:p-0 lg:items-center lg:w-auto text-white text-sm font-thin">
                ...
                <a class="mt-1 block px-2 py-1  hover:text-yellow-500 lg:mt-0 lg:ml-2"
