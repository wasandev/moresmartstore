...
<div class="max-w-full mx-auto bg-gray-300 bg-cover pt-6 mb-4"
    style="background-image:url('{{  Storage::url('mshome6.jpg') }}'); height: 62vh;">
        ...
        <div class="p-6 mt-12 max-w-lg h-64 mx-4 md:mx-auto text-center leading-tight bg-blue-300  rounded-lg shadow-xl" style="opacity: .70;">
            ...
            <div class=" mx-auto flex mt-6 justify-center">
