    ...
    <form action="/products" method="POST" role="search">
        ...
        <div class="max-w-md mx-auto">
            <div class="flex w-full p-4 md:p-4">
                ...
                <input name="product-search" type="text" placeholder="ค้นหาสินค้า" class="transition-colors duration-100 ease-in-out focus:outline-none focus:shadow-md  border border-transparent focus:bg-white  placeholder-gray-600 rounded-full bg-gray-100 py-2 pr-4 pl-10 block w-full appearance-none leading-normal ">
