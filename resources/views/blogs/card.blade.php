<div class="grid grid-cols-1  md:grid-cols-3 ">
    ...
    @foreach ($blogs as $blog)
        <div>
            <a href="/blogs/{{ $blog->slug }}"
                class="flex flex-col shadow hover:shadow-lg translateY-2px m-2 no-underline transition">
    ...
    <div class="lg:hidden ">
        <a href="/home" target="_blank"
            class="flex flex-col flex-1 hover:shadow-lg translateY-2px m-2 p-2 lg:m-4 lg:p-4 no-underline transition">
