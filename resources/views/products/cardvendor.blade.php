<div class="flex flex-col xl:mx-0 ">
    ...
    <a href="/products/{{ $productvendor->id }}" class="bg-blue-500 flex flex-col flex-1 rounded-t-lg shadow hover:shadow-lg translateY-2px m-2 no-underline transition">
        @if ($showimage)
        ...
        @endif
        <h1 class="p-2 text-gray-100 text-base font-light">{{ $productvendor->name }} </h1>
        ...
        <div class="p-2 bg-white flex flex-col flex-1 text-left subpixel-antialiased">
            ...
            <div class="w-full flex flex-row border-t border-gray-100 text-sm font-thin ">
                <div class="text-left w-1/2 mt-2">
                    ...
                    <span class="pl-8 py-2">การดู {{  $productvendor->visits()->count() }} ครั้ง</span>
                </div>
