...
<div id="app"  class="max-w-full mx-auto sm:justify-between sm:items-center  sm:py-3">
    ...
    <div class="flex flex-wrap">
        <nav id = "sidebar-nav" class="sm:block w-full hidden text-sm font-medium md:w-1/4 ">
            <div class="px-2 md:flex sm:p-0 ">
                  <div class="w-full grid grid-cols-1 gap-1  p-2 shadow-lg">
                    @foreach ($category as $item)
                        <a href="/products/category/{{ $item->id }}" class="block py-2 px-2 text-sm font-thin text-gray-100 bg-blue-500 rounded lg:rounded-r-lg border-l-4 border-blue-200 hover:border-red-500 hover:bg-blue-700 hover:text-white">
