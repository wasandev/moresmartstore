...
<div id="app"  class="max-w-full mx-auto sm:justify-between sm:items-center  sm:py-3 bg-white">
    ...
    <div class="flex flex-wrap">
        ...
        <nav id = "pages-nav" class="sm:block w-full hidden text-base font-normal   shadow-lg md:w-1/4 ">
            <div class="hidden sm:block text-blue-700 border border-gray-200 p-2 items-center text-center text-xl rounded">
            ...
            <div class="px-2 sm:flex sm:p-0 ">
                <div class="w-full mx-auto m-1">
                    @foreach ($pages as $listpage)
                        <a href="/pages/{{$listpage->slug}}" class="block p-2 text-base font-normal text-gray-900  rounded-full hover:bg-blue-500 hover:text-white">
